...
# Page configuration
st.set_page_config(
    page_title="[25RP18996]Crop Recommendation System",
    page_icon="🌱",
    layout="centered"
)

st.title("🌱 Crop Recommendation System by 25RP18996")
...
try:
    model_path = os.path.join(BASE_DIR, "crop_model_25RP18996.pkl")  # your model file
    le_path = os.path.join(BASE_DIR, "label_encoder_25RP18996.pkl")         # your actual label encoder file
...
# Footer / info
st.markdown("---")
st.markdown("This app is based on 25RP18996 Crop Recommendation Model**.")
